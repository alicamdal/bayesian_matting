...
```
Terminal application can be run as above. Reqired arguments are input, trimap, groundtruth and new backgorund images. Other arguments have their own default value.
